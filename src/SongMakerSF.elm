...
settingsIconSvg =
    svg
        ...
        [ Svg.path [ SA.d settingsIconSvgPath ] []
        ]



--|> always (Material.Icons.settings iconSize materialIconColor)
